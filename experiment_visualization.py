...
</style></head><body><main><div class="eyebrow">LTspice automation</div><h1>Structured experiment dashboard</h1><p class="muted">Rebuildable human view of the experiment index and comparison artifacts.</p><div class="cards"><div class="card"><span class="muted">Experiments</span><strong>{len(experiments)}</strong></div><div class="card"><span class="muted">Comparisons</span><strong>{len(comparisons)}</strong></div><div class="card"><span class="muted">Index issues</span><strong>{issue_count}</strong></div></div>
