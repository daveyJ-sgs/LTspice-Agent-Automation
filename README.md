...
The included RC low-pass circuit produces a machine-checkable frequency
response as well as the usual LTspice artifacts:

![LTspice RC low-pass frequency response](docs/images/rc-lowpass-response.png)

*RC low-pass response generated by the automation pipeline.*
